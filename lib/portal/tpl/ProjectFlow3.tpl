...
<script>
    $(function(){
        $('#add').click(function(){
            ...
            $.post('?m=Project&a=OnProjectFlow3', {id:$('#id').val(),name:$('#name').val(),no:$('#no').val(),signer:$('#signer').val(),content:$('#content').val(),date:$('#date').val(),comp:$('#comp').val(),date_ping:$('#date_ping').val()
