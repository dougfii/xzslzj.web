<div class="toolbar">
    <div class="tool clear"><span class="cap">外观质量检查与评定项目确认</span><a class="tooladd back" href="javascript:;">返回</a><?php if($new) echo '<a class="tooladd" href="?m=Project&a=ProjectFlow3">新建</a>'; ?></div>
</div>
<div class="panel paneltool">
    ...
    if(!empty($rl)){
        ...
        echo '</tr>';
        echo '<tr>';
        echo '<td><a href="?m=Project&a=ProjectFlow3">' . $rl['no'] . '</a></td>';
    ...
    if(!empty($rs)){
        ...
        foreach($rs as $k => $v){
            echo '<tr>';
            echo '<td><a href="?m=Project&a=ProjectFlow3&id=' . $v['id'] . '">' . $v['no'] . '</a></td>';
